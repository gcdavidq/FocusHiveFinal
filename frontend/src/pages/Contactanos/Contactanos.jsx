...
const Contactanos = () => {
  ...
  // FocusHive es un proyecto académico: el contacto real es el repositorio del proyecto.
  const contactInfo = [
    {
      icon: Mail,
      title: 'Correo',
      items: [{ label: 'Contacto', value: import.meta.env.VITE_CONTACT_EMAIL || 'Configura VITE_CONTACT_EMAIL' }],
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: MessageCircle,
      title: 'Repositorio',
      items: [{ label: 'GitHub', value: import.meta.env.VITE_REPO_URL ? 'Issues y sugerencias en GitHub' : 'Configura VITE_REPO_URL' }],
              ...
              {submitStatus === 'success' && (
                <div className="bg-green-50 border-2 border-green-500 rounded-lg p-4 flex items-center space-x-3 animate-slide-down">
                  ...
                  <p className="text-green-800 font-medium">
                    Gracias por escribir. Este formulario es demostrativo: en esta versión académica el mensaje no se envía a ningún servidor.
                  </p>
                </div>
              )}
            </form>
